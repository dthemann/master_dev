...
% bench_reference_identity (posebusters_results/reference_identity_nearest/identity_cost_summary.json): DiffDock smina
...
% Source: posebusters_results/benchmark_matched_equibind/dock/pose_comparison_report_nearest/per_pose_metrics.csv (303 complexes).
...
% column actual), cross-checked against pose_comparison_report_nearest/pose_validity_cascade.csv (rmsd2_* and triple_*
...
% pose_comparison_report_nearest/topk_recovery_validity_gnina_arm.csv (pbvalid_near_native_k / _pct, gain columns).
...
AutoDock precision & 0.727 & 0.690 & 0.641 & 0.615 & 0.555 \\
...
DiffDock F1 & 0.694 & 0.671 & 0.639 & 0.626 & 0.632 \\
EquiBind complexes n & 266 & 256 & 247 & 245 & 243 \\
EquiBind precision & 0.522 & 0.518 & 0.518 & 0.508 & 0.497 \\
EquiBind recall & 0.486 & 0.475 & 0.475 & 0.459 & 0.444 \\
EquiBind F1 & 0.499 & 0.491 & 0.490 & 0.476 & 0.463 \\
\multicolumn{6}{@{}p{\dimexpr\columnwidth-6\tabcolsep\relax}@{}}{\footnotesize%
...
% TODO (nearest-copy Phase 5, 2026-09-08): the clause 'neither tested refined score improves it' is retained from the
% single-instance build; no rebuilt sidecar in pandamap_results/benchmark_matched_equibind_nearest/report/ re-tests the
% smina / gnina re-ranking against interaction recovery, so it is not re-verified.
AutoDock and DiffDock show no detected difference in nominated rank-1 contact fidelity, but the result is inconclusive rather than equivalent. Gnina ranks AutoDock\textquotesingle s steeply declining series informatively, with all three per-complex Kendall correlations negative and surviving correction. DiffDock\textquotesingle s flatter pool is ordered only weakly by confidence, an association visible only under nearest-copy scoring, and neither tested refined score improves it. EquiBind recovers few native contacts at any rank.
