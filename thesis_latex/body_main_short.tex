...
EquiBind produces at least one valid pose for 266 of 303 complexes, but valid-near-native recovery is only 26.4\% by top-15 and 26.4\% over all thirty poses. Its rank-1 median in-place RMSD of 3.0\angstrom{} already exceeds the near-native threshold. Gnina minimisation repairs some local defects but not gross localisation failures.
