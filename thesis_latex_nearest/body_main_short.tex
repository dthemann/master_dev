...
% TODO (nearest-copy Phase 5, 2026-09-08): the footnote in this paragraph (DiffDock -1 / -2 / -2 complexes under the
% reference-dependent checks) is NOT re-derived. No PoseBusters run with a co-crystallised mol_true exists under the
% nearest convention (run_posebusters.py sets no mol_true path) and no rebuilt sidecar states which file was passed.
% Plan 3.2 row 140 = recompute and name the mol_true file. Values kept as measured on the single reference instance.
