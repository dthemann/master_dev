...
TPL = "template.pptx"
OUT = "Mann_MasterThesis_Defence.pptx"
...
drop(ph[14])
for xh, lbl in ((0.20, "Placement and shape together   ·   in-place RMSD"),
                (5.10, "Shape only   ·   best-fit (Kabsch) RMSD")):
...
bullets(tf, [
    ...
    "depth, so the placement gap is localisation",
...
right everywhere, so the difference between the two leaders is localisation, not
...
caveat(s, 0.20, 4.50, 9.60,
       ...
       "poses lying within 8 Å of the crystal site.", h=0.60)
notes(s, """
