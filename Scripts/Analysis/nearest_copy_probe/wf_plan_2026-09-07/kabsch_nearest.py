...
if __name__ == '__main__':
    ...
    single = df[df.n_copies == 1].sample(50, random_state=0)
    ...
    out.to_csv(WF / 'nearest_copy_kabsch.csv', index=False)
    print('wrote', WF / 'nearest_copy_kabsch.csv', out.shape, flush=True)
