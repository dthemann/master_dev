...
CASES = [
    ...
    Case("15", "docking_effort_comparison (charged)", "moderate",
         ...
         note="the charged basis is invariant to the optimiser worker count under either gnina accounting; only device-occupancy makes its AutoDock GPU term a measured occupancy"),
